...
void resetWifi(){
  ...
  //创建Option标签供用户选择
  String htmlList = "<select id='ssid'><option value='' disabled selected>热点名称</option>";
